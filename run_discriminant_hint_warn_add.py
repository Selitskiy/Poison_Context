...
from run_discriminant_hint_warn import discriminantHintWarnFunct
...
if __name__ == "__main__":
  ...
  for mConf in get_all_models_gen(): #get_open_models_gen(): #get_commercial_models_gen():
    ...
    run_experiment_add(inputFileTpl, inputFileTpl2, experimentTpl, newFields, discriminantHintWarnFunct)
