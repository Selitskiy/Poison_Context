...
def discriminantHintFunct(row_num, row, mConf):
  ...
  if not response2 or not response2Num:
    prompt = prompt_4(haiku, translation, response)
...
if __name__ == "__main__":
  ...
  for mConf in get_all_models_gen(): #get_open_models_gen(): #get_commercial_models_gen():
    ...
    run_experiment(inputFileTpl, experimentTpl, newFields, discriminantHintFunct)
