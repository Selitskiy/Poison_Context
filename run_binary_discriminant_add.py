...
from run_binary_discriminant import binaryDiscriminantFunct
...
if __name__ == "__main__":
  ...
  for mConf in get_all_models_gen(): #get_open_models_gen(): #get_commercial_models_gen():
    ...
    run_binary_experiment_add(inputFileTpl1, inputFileTpl1a, inputFileTpl2, inputFileTpl2a, fileTpl, fileTpl2, modelName, prevExperimentTpl1, prevExperimentTpl2, experimentTpl, newFields, binaryDiscriminantFunct)
